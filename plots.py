...
st.line_chart(data,height=500,width=1000)
...
st.audio("https://commondatastorage.googleapis.com/codeskulptor-demos/DDR_assets/Kangaroo_MusiQue_-_The_Neverwritten_Role_Playing_Game.mp3")

st.video("https://www.dropbox.com/s/s1rc65usypfacde/Sample_1280x720_webm.webm")        